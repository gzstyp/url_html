        ...
        $(window)
            .load(function(){
                obj.nivoSlider({
                    ...
                    // 'fold,fade,sliceDown'
                    slices: 15, animSpeed: 800, pauseTime: 3000, startSlide: 0, // Set starting Slide (0 index)
 ...
 */
pexetoContactForm = {
	emptyNameMessage : '不允许为空',
	invalidEmailMessage : '不允许为空',
	emptyQuestionMessage : '内容不能为空',
	sentMessage : '提交',
	set : function() {
		...
		$("#send_button")
				.click(function(event) {
					...
					valid = true;
						...
						$("#code_text_box").removeClass('invalid');
						...
						var code_text_box = $("#code_text_box");
						var email = code_text_box.val();
						if (!pexetoContactForm.isValidEmailAddress(email)) {
                            code_text_box.addClass('invalid');
							valid = false;
							$(
									'<div class="question_icon"></div><div class="contact_message"><p>' + pexetoContactForm.invalidEmailMessage + '</p></div>')
									.insertAfter(code_text_box);
						}
