...
;var paginator = {
    ...
    emptyOrError:function(){
        ...
        page += "<ol class='fanYe'>";
        page += "<li><a href='javascript:;' title='不能操作' class='disabled' style='cursor:not-allowed;'>第一页</a></li>";
        page += "<li><a href='javascript:;' title='不能操作' class='disabled' style='cursor:not-allowed;'>上一页</a></li>";
        page += "<li><a href='javascript:;' title='不能操作' class='disabled' style='cursor:not-allowed;'>下一页</a></li>";
        page += "<li><a href='javascript:;' title='不能操作' class='disabled' style='cursor:not-allowed;'>最后页</a></li>";
        page += "</ol>";
    ...
    pageBarLoad:function(result,method,display){//当display有值时或为true时分页条有等待提示
        ...
        if(result.current == 1){
            ...
            page += "<li><a href='javascript:"+method+"(1);' title='最前页' class='available'>第一页</a></li>";
            page += "<li><a href='javascript:"+method+"("+(result.current-1)+");' title='上一页' class='available'>上一页</a></li>";
        }
        if(result.current == result.totalPage){
            page += "<li><a href='javascript:;' title='不能操作' class='disabled' style='cursor:not-allowed;'>下一页</a></li>";
            page += "<li><a href='javascript:;' title='不能操作' class='disabled' style='cursor:not-allowed;'>最后页</a></li>";
        }else{
            page += "<li><a href='javascript:"+method+"("+(result.current+1)+");' title='下一页' class='available'>下一页</a></li>";
            page += "<li><a href='javascript:"+method+"("+(result.totalPage)+");' title='最后一页' class='available'>最后页</a></li>";
        }
        page += "</ol>";
        page += "<div class='clear'></div>";
        page += "</div>";
